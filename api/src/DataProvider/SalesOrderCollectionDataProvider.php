...
/**
 * Class SalesOrderCollectionDataProvider
 * @package App\DataProvider
 */
final class SalesOrderCollectionDataProvider implements CollectionDataProviderInterface, RestrictedDataProviderInterface
{
	...
	public function __construct(ContainerInterface $container)
	{
		...
		if ($this->container->hasParameter('entity.sales_order')) {
			...
			throw new \UnexpectedValueException("Data entity name for sales order is not properly configured");
		}
	}
	...
	public function getCollection(string $resourceClass, string $operationName = null): \Generator
	{
		...
		if (!is_null($query->get('customerAccount'))) {
			$filter[] = "InvoiceCustomerAccountNumber eq '" . $query->get('customerAccount') . "'";
		}
